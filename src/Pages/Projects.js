...
const Projects = () => {
    ...
    const projectList = [
        ...
        { name: 'PIDControlledBridge', image: Background, title: 'PID Controlled Bridge', description: "Balancing a mini-kart on a bridge with PID" },
      ...
      <div className="background-overlay"></div>
        <div className="overlay">
          <div className="overlay-content">
            <h1>Projects</h1>
            <h3>Checkout the cool projects I've done over the years!</h3>
